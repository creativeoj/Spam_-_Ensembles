...
ab_mod = AdaBoostClassifier(n_estimators=200, learning_rate=0.2)
...
ab_mod.fit(training_data, y_train)
...
ab_preds = ab_mod.predict(testing_data)
...
print_metrics(y_test, ab_preds, 'adaboost')
